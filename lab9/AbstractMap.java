...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    private class Keylterator implements Iterator<K> {
        ...
        //This method is required by the Iterator interface, but it is not implemented (throw new UnsupportedOperationException()). This means that attempts to remove an element using this iterator will result in an UnsupportedOperationException.
        public void remove() {
